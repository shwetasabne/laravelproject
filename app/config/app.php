...
return array(
	...
	*/
	...
	'key' => 'EY2lXbuKBAaKQBa7rIYc0tLHnkUPoCoO',
	...
	*/
	...
	/*
	|--------------------------------------------------------------------------
	| Answer to the POST VIRUS question
	|--------------------------------------------------------------------------
	|
	| This variable is used to check that only the right person is setting
	| the values of projects.
	*/
	
	'secret_post_answer' => $_ENV['POST_VIRUS_ANSWER'],
